...
import gred.nucleus.multiThread.ProcessImageOtherSeg;
...
public class OtherBatch_ implements PlugIn
{
	...
	public void run(String arg)
	{
		...
		if (_nucleusSegmentationBatchDialog.isStart())
		{
			...
			else
			{
				...
				ProcessImageOtherSeg processImageOtherSeg = new ProcessImageOtherSeg();
				try 
				{	processImageOtherSeg.go(this, tRawImageFile,false);
