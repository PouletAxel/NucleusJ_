...
/**
 * Modification de ce plugin pour l'adpater à la chaine de traitement
 * Coreection de ceratine méthode
 * @author Fabrice P. Cordeli�res, fabrice.cordelieres@gmail.com
 * @version 1.0, 7/11/07
 */
public class MyCounter3D{
    int thr=0;
    boolean[] isSurf;
     ...
     */
     public MyCounter3D(ImagePlus img, int thr, int min, int max, boolean exclude, boolean redirect) {
     ...
     * @param thr specifies the threshold value (should be an Integer).
     */
    public MyCounter3D(ImagePlus img, int thr) {
     ...
     * @param img specifies the image to convert into an Counter3D.
     */
    public MyCounter3D(ImagePlus img) {
     ...
     */
    public MyCounter3D(int[] img, String title, int width, int height, int nbSlices, int thr, int min, int max, boolean exclude, boolean redirect, Calibration cal) {
        this.title=title;
        this.width=width;
        this.height=height;
     ...
     * @param cal specifies the image calibration to be used.
     */
    public MyCounter3D(int[] img, String title, int width, int height, int nbSlices, int thr, Calibration cal) {
     ...
     * @param thr specifies the threshold value (should be an Integer).
     */
    public MyCounter3D(int[] img, String title, int width, int height, int nbSlices, int thr) {
     ...
     * @param cal specifies the image calibration to be used.
     */
    public MyCounter3D(int[] img, String title, int width, int height, int nbSlices, Calibration cal) {
     ...
     * @param nbSlices specifies the image number of slices.
     */
    public MyCounter3D(int[] img, String title, int width, int height, int nbSlices) {
    ...
    private void getObjects(){
        ...
        if (!this.getObjects){
            this.obj=new MyObject3D[this.nbObj];

            for (int i=0; i<this.nbObj; i++) this.obj[i]=new MyObject3D(this.IDcount[i+1], this.cal);
            this.IDcount=null;
     ...
     */
    public MyObject3D[] getObjectsList(){
